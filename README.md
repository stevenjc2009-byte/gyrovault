...
![QR code linking to the gyrovault 3.0.1 VPK](docs/install-qr.png)

It encodes `https://github.com/stevenjc2009-byte/gyrovault/releases/download/v3.0.1/gyrovault.vpk`, so it installs **3.0.1** and nothing else. The code is pinned to its own version: this page's code always gives you 3.0.1, and each future release carries its own code for that release.
